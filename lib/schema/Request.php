...
class Schema_Request
{
  public static function get()
  {
    ...
    $cols['request_id'] = array('type' => Sabel_Db_Type::INT, 'max' => 2147483647, 'min' => -2147483648, 'increment' => false, 'nullable' => false, 'primary' => true, 'default' => null);
  ...
  public function getProperty()
  {
    ...
    $property['fkeys']['user_id'] = array('referenced_table'  => 'users',
                                         ...
                                         'on_delete'         => 'NO ACTION',
                                         'on_update'         => 'NO ACTION');
    $property['fkeys']['request_id'] = array('referenced_table'  => 'users',
                                         'referenced_column' => 'uid',
                                         'on_delete'         => 'NO ACTION',
                                         'on_update'         => 'NO ACTION');
